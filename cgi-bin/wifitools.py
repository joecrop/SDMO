...
def get_table():
    ...
    return print_cells(parsed_cells)
   
def get_connection_info(metric):
    ip = ni.ifaddresses(interface)[2][0]['addr']
    broadcast = ni.ifaddresses(interface)[2][0]['broadcast']
    netmask = ni.ifaddresses(interface)[2][0]['netmask']
    mac = ni.ifaddresses(interface)[int(ni.AF_LINK)][0]['addr']

    if metric == 'ip':
        return ip
    elif metric == 'broadcast':
        return broadcast
    elif metric == 'mask':
        return netmask
    elif metric == 'mac':
